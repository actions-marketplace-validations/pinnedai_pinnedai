...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "POST /api/signup returns 400 on missing body"
...
//   pinned retire baseline-20260525-returns-status-api-signup-1l8a3d --reason="..."
// ═══════════════════════════════════════════════════════════════
...
const ORIGINAL_CLAIM = "POST /api/signup returns 400 on missing body";
const BAD_CASE = "POST /api/signup (missing body) returned a status other than 400 (validation removed or weakened)";
const TEST_FILENAME = "baseline-20260525-returns-status-api-signup-1l8a3d.test.ts";
