...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "config-invariant Pinned guardrail block in CLAUDE.md"
// Source PR:         baseline-20260525
// Template:          config-invariant
// Protects:          Pinned guardrail block in CLAUDE.md
// Permanent:         this test fails if the claim is ever regressed.
//
// Retire when the invariant intentionally changes:
//   pinned retire baseline-20260525-config-invariant-config-claude-md-pinned-guardrail-block-8e4egd --reason="..."
// ═══════════════════════════════════════════════════════════════
...
const CONFIG_PATH = "CLAUDE.md";
const EXPECTED = "<!-- pinnedai:start -->";
const LABEL = "Pinned guardrail block";
const ORIGINAL_PR = "baseline-20260525";
const ORIGINAL_CLAIM = "config-invariant Pinned guardrail block in CLAUDE.md";
const TEST_FILENAME = "baseline-20260525-config-invariant-config-claude-md-pinned-guardrail-block-8e4egd.test.ts";
