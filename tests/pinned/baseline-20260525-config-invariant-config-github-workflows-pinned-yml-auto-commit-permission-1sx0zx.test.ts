...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "config-invariant auto-commit permission in .github/workflows/pinned.yml"
// Source PR:         baseline-20260525
// Template:          config-invariant
// Protects:          auto-commit permission in .github/workflows/pinned.yml
// Permanent:         this test fails if the claim is ever regressed.
//
// Retire when the invariant intentionally changes:
//   pinned retire baseline-20260525-config-invariant-config-github-workflows-pinned-yml-auto-commit-permission-1sx0zx --reason="..."
// ═══════════════════════════════════════════════════════════════
...
const EXPECTED = "contents: write";
const LABEL = "auto-commit permission";
const ORIGINAL_PR = "baseline-20260525";
const ORIGINAL_CLAIM = "config-invariant auto-commit permission in .github/workflows/pinned.yml";
const TEST_FILENAME = "baseline-20260525-config-invariant-config-github-workflows-pinned-yml-auto-commit-permission-1sx0zx.test.ts";
