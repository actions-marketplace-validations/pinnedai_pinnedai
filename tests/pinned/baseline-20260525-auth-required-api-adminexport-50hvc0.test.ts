...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "Auth required on /api/adminExport"
...
//   pinned retire baseline-20260525-auth-required-api-adminexport-50hvc0 --reason="..."
// ═══════════════════════════════════════════════════════════════
...
const ROUTE = "/api/adminExport";
const ORIGINAL_PR = "baseline-20260525";
const ORIGINAL_CLAIM = "Auth required on /api/adminExport";
const BAD_CASE = "an unauthenticated request to /api/adminExport returned 2xx instead of 401/403";
const TEST_FILENAME = "baseline-20260525-auth-required-api-adminexport-50hvc0.test.ts";
