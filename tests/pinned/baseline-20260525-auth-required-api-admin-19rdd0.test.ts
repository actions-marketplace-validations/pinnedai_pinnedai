...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "Auth required on /api/admin"
...
//   pinned retire baseline-20260525-auth-required-api-admin-19rdd0 --reason="..."
// ═══════════════════════════════════════════════════════════════
...
const ORIGINAL_CLAIM = "Auth required on /api/admin";
const BAD_CASE = "an unauthenticated request to /api/admin returned 2xx instead of 401/403";
const TEST_FILENAME = "baseline-20260525-auth-required-api-admin-19rdd0.test.ts";
