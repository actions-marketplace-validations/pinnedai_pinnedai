...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "`node ./apps/cli/dist/cli.js backtest --help` exits 0"
// Source PR:         auto-20260522
// Template:          cli-exits-zero
// Permanent:         this test fails if the claim is ever regressed.
//
// Retire when no longer applicable:
//   pinned retire auto-20260522-cli-exits-zero-node-apps-cli-dist-cli-js-backtest-help-b71h5x --reason="..."
// ═══════════════════════════════════════════════════════════════

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js backtest --help";
const ARGV = ["node","./apps/cli/dist/cli.js","backtest","--help"];
const ORIGINAL_PR = "auto-20260522";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js backtest --help` exits 0";
const TEST_FILENAME = "auto-20260522-cli-exits-zero-node-apps-cli-dist-cli-js-backtest-help-b71h5x.test.ts";
