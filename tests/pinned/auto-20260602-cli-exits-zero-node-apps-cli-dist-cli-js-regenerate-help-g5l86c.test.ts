...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "`node ./apps/cli/dist/cli.js regenerate --help` exits 0"
// Source PR:         auto-20260602
// Template:          cli-exits-zero
// Permanent:         this test fails if the claim is ever regressed.
//
// Retire when no longer applicable:
//   pinned retire auto-20260602-cli-exits-zero-node-apps-cli-dist-cli-js-regenerate-help-g5l86c --reason="..."
// ═══════════════════════════════════════════════════════════════

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js regenerate --help";
const ARGV = ["node","./apps/cli/dist/cli.js","regenerate","--help"];
const ORIGINAL_PR = "auto-20260602";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js regenerate --help` exits 0";
const TEST_FILENAME = "auto-20260602-cli-exits-zero-node-apps-cli-dist-cli-js-regenerate-help-g5l86c.test.ts";
