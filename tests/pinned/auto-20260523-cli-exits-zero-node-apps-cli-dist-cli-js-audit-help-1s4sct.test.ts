...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "`node ./apps/cli/dist/cli.js audit --help` exits 0"
...
//   pinned retire auto-20260523-cli-exits-zero-node-apps-cli-dist-cli-js-audit-help-1s4sct --reason="..."
// ═══════════════════════════════════════════════════════════════

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js audit --help";
const ARGV = ["node","./apps/cli/dist/cli.js","audit","--help"];
const ORIGINAL_PR = "auto-20260523";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js audit --help` exits 0";
const TEST_FILENAME = "auto-20260523-cli-exits-zero-node-apps-cli-dist-cli-js-audit-help-1s4sct.test.ts";
